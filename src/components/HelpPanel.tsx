...
export default function HelpPanel({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="settings-overlay" onClick={onClose} role="dialog" aria-label="Help">
...
function Shortcuts() {
  const shortcuts = [
    ...
    { keys: 'F2', action: 'Rename selected item (when right-clicked)' },
...
function Features() {
  return (
    <div className="help-content">
      ...
      <section className="help-section">
        <h3>Source View</h3>
        <p>Use the source mode toggle in the editor toolbar to switch between rich-text editing and raw markdown source. You can also view a diff of your changes.</p>
      </section>
